package com.lounah.vkmc.feature.image_viewer.immersive;
...
public final class SystemUiHelper {
     ...
     */
    public SystemUiHelper(Activity activity, int level, int flags, OnSystemUiVisibilityChangeListener listener) {
