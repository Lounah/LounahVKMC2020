...
import com.lounah.vkmc.core.extensions.ContextExtKt;
...
public class CircleTextSpan extends ReplacementSpan {
    ...
    public void draw(@NonNull Canvas canvas,
        ...
        canvas.drawCircle(x + ContextExtKt.getDp(28) + size / 2, (bottom - top) / 2, size / 2, paint);
        paint.setColor(textColor);
        canvas.drawText(text, start, end, x + padding + ContextExtKt.getDp(28), y, paint);
    }
