...
fun RecyclerView.endlessScrollObservable(pageSize: Int = DEFAULT_PAGE_SIZE,
                                         threshHold: Int = DEFAULT_THRESHOLD): Observable<Int> {
    return SimpleEndlessScrollObservable(this, pageSize, threshHold)
}

private class SimpleEndlessScrollObservable(private val recycler: RecyclerView,
                                            private val pageSize: Int,
                                            private val threshHold: Int) : Observable<Int>() {
    ...
    class SimpleEndLessScrollListener(recycler: RecyclerView,
